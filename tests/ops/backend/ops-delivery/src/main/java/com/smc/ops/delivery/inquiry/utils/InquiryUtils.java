...
public class InquiryUtils {
     ...
     * @return
     */
    public synchronized static String createIncrementId(String prefix, Date date, String dateFormat, int digit , String lastId) {
    ...
    public static void main(String[] args) {
        System.out.println(getDayTimeEnd(new Date()));
    }
