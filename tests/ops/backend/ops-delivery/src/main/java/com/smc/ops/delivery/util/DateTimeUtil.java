...
public class DateTimeUtil {
    ...
    public static String getStartDateTimeStr(Date date) {
        return DateTimeUtil.dateToDateString(date)+" 00:00:00";
    }

    public static String getEndDateTimeStr(Date date) {
        return DateTimeUtil.dateToDateString(date)+" 23:59:59";
    }
    ...
    public static void main(String[] args) {
        // getDiffDay
//        String date1= "2023-03-07";
//        Date date = stringToDate(date1);
//
//        String date2 = "2023-08-18 00:00:00.000";
//        Date date3 = stringToDateTime(date2);
//        Date today = getToday();
//        System.out.println("dateToString(today) = " + dateToString(today));
        Long diffDay = getDiffDay(new Date(), DateTimeUtil.stringToDate("9024-2-29"));
