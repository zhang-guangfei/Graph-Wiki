...
public class ShikomiNew implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        ShikomiNew other = (ShikomiNew) that;
        return (this.getAnswerno() == null ? other.getAnswerno() == null : this.getAnswerno().equals(other.getAnswerno()))
