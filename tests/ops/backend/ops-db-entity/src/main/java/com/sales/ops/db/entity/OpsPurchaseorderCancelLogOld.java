...
public class OpsPurchaseorderCancelLogOld implements Serializable {
    private Long id;
    ...
    public Boolean getCtcsysn() {
        return ctcsysn;
    }

    public void setCtcsysn(Boolean ctcsysn) {
        this.ctcsysn = ctcsysn;
    }
    ...
    public boolean equals(Object that) {
        ...
        OpsPurchaseorderCancelLogOld other = (OpsPurchaseorderCancelLogOld) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getCtcsysn() == null ? other.getCtcsysn() == null : this.getCtcsysn().equals(other.getCtcsysn()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCtcsysn() == null) ? 0 : getCtcsysn().hashCode());
