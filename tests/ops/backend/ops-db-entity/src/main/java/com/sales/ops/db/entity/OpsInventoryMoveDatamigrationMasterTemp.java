...
public class OpsInventoryMoveDatamigrationMasterTemp implements Serializable {
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        OpsInventoryMoveDatamigrationMasterTemp other = (OpsInventoryMoveDatamigrationMasterTemp) that;
