...
public class OpsDo implements Serializable {
    private Long id;
    ...
    private Integer roCrossType;

    private String relocation;

    private String wtWarehouseLocation;
    ...
    private Date doReadyTime;

    private Date dbReadyTime;
    ...
    public Integer getRoCrossType() {
        return roCrossType;
    }

    public void setRoCrossType(Integer roCrossType) {
        this.roCrossType = roCrossType;
    }
    ...
    public String getWtWarehouseLocation() {
        return wtWarehouseLocation;
    }

    public void setWtWarehouseLocation(String wtWarehouseLocation) {
        this.wtWarehouseLocation = wtWarehouseLocation == null ? null : wtWarehouseLocation.trim();
    }
    ...
    public void setReadyReason(String readyReason) {
        this.readyReason = readyReason == null ? null : readyReason.trim();
    }
    ...
    public Date getTmsExpectedDeliveryDate() {
        return tmsExpectedDeliveryDate;
    }

    public void setTmsExpectedDeliveryDate(Date tmsExpectedDeliveryDate) {
        this.tmsExpectedDeliveryDate = tmsExpectedDeliveryDate;
    }

    public Date getWmsExpectedDeliveryDate() {
        return wmsExpectedDeliveryDate;
    }

    public void setWmsExpectedDeliveryDate(Date wmsExpectedDeliveryDate) {
        this.wmsExpectedDeliveryDate = wmsExpectedDeliveryDate;
    }

    public Date getDoReadyTime() {
        return doReadyTime;
    }

    public void setDoReadyTime(Date doReadyTime) {
        this.doReadyTime = doReadyTime;
    }

    public Date getDbReadyTime() {
        return dbReadyTime;
    }

    public void setDbReadyTime(Date dbReadyTime) {
        this.dbReadyTime = dbReadyTime;
    }
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getRoCrossType() == null ? other.getRoCrossType() == null : this.getRoCrossType().equals(other.getRoCrossType()))
            && (this.getRelocation() == null ? other.getRelocation() == null : this.getRelocation().equals(other.getRelocation()))
            && (this.getWtWarehouseLocation() == null ? other.getWtWarehouseLocation() == null : this.getWtWarehouseLocation().equals(other.getWtWarehouseLocation()))
            && (this.getWmsStatus() == null ? other.getWmsStatus() == null : this.getWmsStatus().equals(other.getWmsStatus()))
            && (this.getWaveTime() == null ? other.getWaveTime() == null : this.getWaveTime().equals(other.getWaveTime()))
            && (this.getWmsTime() == null ? other.getWmsTime() == null : this.getWmsTime().equals(other.getWmsTime()))
            && (this.getReadyReason() == null ? other.getReadyReason() == null : this.getReadyReason().equals(other.getReadyReason()))
            && (this.getEmail() == null ? other.getEmail() == null : this.getEmail().equals(other.getEmail()))
            && (this.getTmsExpectedDeliveryDate() == null ? other.getTmsExpectedDeliveryDate() == null : this.getTmsExpectedDeliveryDate().equals(other.getTmsExpectedDeliveryDate()))
            && (this.getWmsExpectedDeliveryDate() == null ? other.getWmsExpectedDeliveryDate() == null : this.getWmsExpectedDeliveryDate().equals(other.getWmsExpectedDeliveryDate()))
            && (this.getDoReadyTime() == null ? other.getDoReadyTime() == null : this.getDoReadyTime().equals(other.getDoReadyTime()))
            && (this.getDbReadyTime() == null ? other.getDbReadyTime() == null : this.getDbReadyTime().equals(other.getDbReadyTime()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getRoCrossType() == null) ? 0 : getRoCrossType().hashCode());
        result = prime * result + ((getRelocation() == null) ? 0 : getRelocation().hashCode());
        result = prime * result + ((getWtWarehouseLocation() == null) ? 0 : getWtWarehouseLocation().hashCode());
        result = prime * result + ((getWmsStatus() == null) ? 0 : getWmsStatus().hashCode());
        result = prime * result + ((getWaveTime() == null) ? 0 : getWaveTime().hashCode());
        result = prime * result + ((getWmsTime() == null) ? 0 : getWmsTime().hashCode());
        result = prime * result + ((getReadyReason() == null) ? 0 : getReadyReason().hashCode());
        result = prime * result + ((getEmail() == null) ? 0 : getEmail().hashCode());
        result = prime * result + ((getTmsExpectedDeliveryDate() == null) ? 0 : getTmsExpectedDeliveryDate().hashCode());
        result = prime * result + ((getWmsExpectedDeliveryDate() == null) ? 0 : getWmsExpectedDeliveryDate().hashCode());
        result = prime * result + ((getDoReadyTime() == null) ? 0 : getDoReadyTime().hashCode());
        result = prime * result + ((getDbReadyTime() == null) ? 0 : getDbReadyTime().hashCode());
