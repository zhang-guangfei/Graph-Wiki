...
public class VShikomiTotal implements Serializable {
    private Long id;
    ...
    public void setMainmodelno(String mainmodelno) {
        this.mainmodelno = mainmodelno == null ? null : mainmodelno.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        VShikomiTotal other = (VShikomiTotal) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getMainmodelno() == null ? other.getMainmodelno() == null : this.getMainmodelno().equals(other.getMainmodelno()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getMainmodelno() == null) ? 0 : getMainmodelno().hashCode());
