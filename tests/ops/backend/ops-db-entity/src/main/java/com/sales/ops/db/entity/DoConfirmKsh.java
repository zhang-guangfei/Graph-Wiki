...
public class DoConfirmKsh implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        DoConfirmKsh other = (DoConfirmKsh) that;
        return (this.getDeliveryordercode() == null ? other.getDeliveryordercode() == null : this.getDeliveryordercode().equals(other.getDeliveryordercode()))
