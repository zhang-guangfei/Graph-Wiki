...
public class OpsWarehouse implements Serializable {
    ...
    public String getRcvLinkman() {
        return rcvLinkman;
    }

    public void setRcvLinkman(String rcvLinkman) {
        this.rcvLinkman = rcvLinkman == null ? null : rcvLinkman.trim();
    }

    public String getRcvLinkTel() {
        return rcvLinkTel;
    }

    public void setRcvLinkTel(String rcvLinkTel) {
        this.rcvLinkTel = rcvLinkTel == null ? null : rcvLinkTel.trim();
    }

    public String getRcvLinkEmail() {
        return rcvLinkEmail;
    }

    public void setRcvLinkEmail(String rcvLinkEmail) {
        this.rcvLinkEmail = rcvLinkEmail == null ? null : rcvLinkEmail.trim();
    }
    ...
    public Boolean getPrestockFlag() {
        return prestockFlag;
    }

    public void setPrestockFlag(Boolean prestockFlag) {
    ...
    public boolean equals(Object that) {
        ...
        OpsWarehouse other = (OpsWarehouse) that;
        return (this.getWarehouseCode() == null ? other.getWarehouseCode() == null : this.getWarehouseCode().equals(other.getWarehouseCode()))
            ...
            && (this.getAdress() == null ? other.getAdress() == null : this.getAdress().equals(other.getAdress()))
                ...
                && (this.getRcvLinkman() == null ? other.getRcvLinkman() == null : this.getRcvLinkman().equals(other.getRcvLinkman()))
                && (this.getRcvLinkTel() == null ? other.getRcvLinkTel() == null : this.getRcvLinkTel().equals(other.getRcvLinkTel()))
                && (this.getRcvLinkEmail() == null ? other.getRcvLinkEmail() == null : this.getRcvLinkEmail().equals(other.getRcvLinkEmail()))
                ...
                && (this.getPrestockFlag() == null ? other.getPrestockFlag() == null : this.getPrestockFlag().equals(other.getPrestockFlag()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getRcvLinkman() == null) ? 0 : getRcvLinkman().hashCode());
        result = prime * result + ((getRcvLinkTel() == null) ? 0 : getRcvLinkTel().hashCode());
        result = prime * result + ((getRcvLinkEmail() == null) ? 0 : getRcvLinkEmail().hashCode());
        ...
        result = prime * result + ((getPrestockFlag() == null) ? 0 : getPrestockFlag().hashCode());
        return result;
    }
}