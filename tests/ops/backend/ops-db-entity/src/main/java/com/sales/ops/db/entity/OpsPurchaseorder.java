...
public class OpsPurchaseorder implements Serializable {
    private Long id;
    ...
    public String getUnusualMessage() {
        return unusualMessage;
    }

    public void setUnusualMessage(String unusualMessage) {
        this.unusualMessage = unusualMessage == null ? null : unusualMessage.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        OpsPurchaseorder other = (OpsPurchaseorder) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getUnusualMessage() == null ? other.getUnusualMessage() == null : this.getUnusualMessage().equals(other.getUnusualMessage()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getUnusualMessage() == null) ? 0 : getUnusualMessage().hashCode());
