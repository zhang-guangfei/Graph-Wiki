...
public class OpsRequestpurchaseCancelLog implements Serializable {
    private Long id;
    ...
    public void setShikomirelease(String shikomirelease) {
        this.shikomirelease = shikomirelease == null ? null : shikomirelease.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        OpsRequestpurchaseCancelLog other = (OpsRequestpurchaseCancelLog) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getShikomirelease() == null ? other.getShikomirelease() == null : this.getShikomirelease().equals(other.getShikomirelease()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getShikomirelease() == null) ? 0 : getShikomirelease().hashCode());
