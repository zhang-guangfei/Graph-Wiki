...
public class OpsInquiryPoHandle implements Serializable {
    private Long id;
    ...
    private String inquiryHandleResult;
    ...
    public String getInquiryHandleResult() {
        return inquiryHandleResult;
    }

    public void setInquiryHandleResult(String inquiryHandleResult) {
        this.inquiryHandleResult = inquiryHandleResult == null ? null : inquiryHandleResult.trim();
    }
    ...
    public void setInquiryReasonType(String inquiryReasonType) {
        this.inquiryReasonType = inquiryReasonType == null ? null : inquiryReasonType.trim();
    }
    ...
    public void setInquiryReason(String inquiryReason) {
        this.inquiryReason = inquiryReason == null ? null : inquiryReason.trim();
    }
    ...
    public void setInquiryRemark(String inquiryRemark) {
        this.inquiryRemark = inquiryRemark == null ? null : inquiryRemark.trim();
    }
    ...
    public void setInquiryDept(String inquiryDept) {
        this.inquiryDept = inquiryDept == null ? null : inquiryDept.trim();
    }
    ...
    public void setInquiryUser(String inquiryUser) {
        this.inquiryUser = inquiryUser == null ? null : inquiryUser.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        OpsInquiryPoHandle other = (OpsInquiryPoHandle) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getInquiryStatus() == null ? other.getInquiryStatus() == null : this.getInquiryStatus().equals(other.getInquiryStatus()))
            && (this.getInquiryHandleResult() == null ? other.getInquiryHandleResult() == null : this.getInquiryHandleResult().equals(other.getInquiryHandleResult()))
            ...
            && (this.getInquiryReasonType() == null ? other.getInquiryReasonType() == null : this.getInquiryReasonType().equals(other.getInquiryReasonType()))
            && (this.getInquiryReason() == null ? other.getInquiryReason() == null : this.getInquiryReason().equals(other.getInquiryReason()))
            && (this.getInquiryDescription() == null ? other.getInquiryDescription() == null : this.getInquiryDescription().equals(other.getInquiryDescription()))
            && (this.getInquiryRemark() == null ? other.getInquiryRemark() == null : this.getInquiryRemark().equals(other.getInquiryRemark()))
            && (this.getInquiryType() == null ? other.getInquiryType() == null : this.getInquiryType().equals(other.getInquiryType()))
            && (this.getInquiryTime() == null ? other.getInquiryTime() == null : this.getInquiryTime().equals(other.getInquiryTime()))
            && (this.getInquiryDept() == null ? other.getInquiryDept() == null : this.getInquiryDept().equals(other.getInquiryDept()))
            && (this.getInquiryUser() == null ? other.getInquiryUser() == null : this.getInquiryUser().equals(other.getInquiryUser()))
            && (this.getInquiryUserName() == null ? other.getInquiryUserName() == null : this.getInquiryUserName().equals(other.getInquiryUserName()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getInquiryHandleResult() == null) ? 0 : getInquiryHandleResult().hashCode());
        ...
        result = prime * result + ((getInquiryReasonType() == null) ? 0 : getInquiryReasonType().hashCode());
        result = prime * result + ((getInquiryReason() == null) ? 0 : getInquiryReason().hashCode());
        result = prime * result + ((getInquiryDescription() == null) ? 0 : getInquiryDescription().hashCode());
        result = prime * result + ((getInquiryRemark() == null) ? 0 : getInquiryRemark().hashCode());
        ...
        result = prime * result + ((getInquiryDept() == null) ? 0 : getInquiryDept().hashCode());
        result = prime * result + ((getInquiryUser() == null) ? 0 : getInquiryUser().hashCode());
        result = prime * result + ((getInquiryUserName() == null) ? 0 : getInquiryUserName().hashCode());
