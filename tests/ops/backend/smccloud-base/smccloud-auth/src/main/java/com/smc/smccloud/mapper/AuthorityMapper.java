...
public interface AuthorityMapper extends BaseMapper<Authority> {
     ...
     * @return
     */
    @Select("SELECT SA.ID FROM sales_sys_authority SA WHERE SA.TYPE='common'")
    List<String> getCommonAuthority();

    /**
     * 通过CODE删除
     * @param code
     */
    @Delete("DELETE FROM sales_sys_authority WHERE CODE LIKE CONCAT(#{code},'%')")
