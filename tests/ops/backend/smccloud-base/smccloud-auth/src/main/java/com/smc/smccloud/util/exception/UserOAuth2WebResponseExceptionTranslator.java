...
public class UserOAuth2WebResponseExceptionTranslator implements WebResponseExceptionTranslator<OAuth2Exception> {
    ...
    private static class MethodNotAllowed extends OAuth2Exception {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 2956075077960861096L;
    ...
    private static class UnauthorizedException extends OAuth2Exception {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 5245390802789781797L;
    ...
    private static class ServerErrorException extends OAuth2Exception {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -8060991392037411647L;
    ...
    private static class ForbiddenException extends OAuth2Exception {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 7735325823658299616L;
