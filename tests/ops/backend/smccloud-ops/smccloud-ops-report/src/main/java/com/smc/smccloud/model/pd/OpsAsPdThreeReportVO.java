 ...
 */
@Data
public class OpsAsPdThreeReportVO {
     ...
     */
    @HeadStyle(fillForegroundColor = 42)
    @ExcelProperty("wms采购到货未入")
    private int wmsPurchaseNoIn;

    @HeadStyle(fillForegroundColor = 42)
    @ExcelProperty("wms退货到货未入")
    ...
    // ops组换在途
    @HeadStyle(fillForegroundColor = 45)
    @ExcelProperty("ops组换在途")
    private int opsZhZt;

    // ops组换到货未入
    @HeadStyle(fillForegroundColor = 46)
