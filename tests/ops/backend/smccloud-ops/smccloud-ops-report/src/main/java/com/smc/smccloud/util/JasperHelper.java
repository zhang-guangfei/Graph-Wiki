...
public class JasperHelper {
    ...
    public static JasperPrint crePdfWithJasperPrint(InputStream inputStream, Map<String, Object> params, Collection<?> beanCollection) throws JRException {
