...
public enum PoReplyDateStrEnum {
	EIGHT888888("88/88/88", "日本制造部正在向日本研发中心要图纸"), TWO222222("22/22/22", "型号确认中订单正转交正确部门"), THREE333333("33/33/33",
			"正在日本研发中心组装"), FOUR444444("44/44/44", "紧急停止供货"), FIVE555555("55/55/55", "部品定向其他工厂,无确切交货期"), SIX666666(
					"66/66/66", "部品定向外协,无确切交货期"), SEVEN777777("77/77/77", "加工完毕日期不确定,正在确认中"), NINE999999("99/99/99",
							"订单异常,请登录AS400查看异常原因并及时进行处理"), NINE990000("99/00/00", "要提供样式书"), EIGHT("888888",
									"日本制造部正在向日本研发中心要图纸"), TWO("222222", "型号确认中订单正转交正确部门"), THREE("333333",
											"正在日本研发中心组装"), FOUR("444444", "紧急停止供货"), FIVE("555555",
													"部品定向其他工厂,无确切交货期"), SIX("666666", "部品定向外协,无确切交货期"), SEVEN("777777",
															"加工完毕日期不确定,正在确认中"), NINE("999999",
																	"订单异常,请登录AS400查看异常原因并及时进行处理"), NINE00("990000",
																			"要提供样式书");
