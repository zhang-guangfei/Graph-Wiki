...
public class PoReplyInfoDto implements Serializable {

	/**
	 * bug12769 采购返信变更提醒
	 */
	private static final long serialVersionUID = 45969721623687471L;
	...
	public String getReplyDateModBefore() {
		return replyDateModBefore;
	}

	public void setReplyDateModBefore(String replyDateModBefore) {
		this.replyDateModBefore = replyDateModBefore;
	}

	public String getReplyDateMod() {
		return replyDateMod;
	}

	public void setReplyDateMod(String replyDateMod) {
	...
	public String getPurchaseStateCode() {
		return purchaseStateCode;
	}

	public void setPurchaseStateCode(String purchaseStateCode) {
