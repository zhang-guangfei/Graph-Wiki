...
@Slf4j
@Component
public class EnglishFanYiUtil {

    private final static String BAI_DU_TRANSLATE_API = "https://fanyi-api.baidu.com/api/trans/vip/translate";
    // private final static String APP_ID = "20230508001670327";
    private final static String SALT = "123456";
    // private final static String PASSWORD = "grBoQZa5DSK4PR_aA4J8";
     ...
     * @return 英文字符
     */
    public static String converToEN(String chinese,String appId,String pwd) {
        try {
        ...
        params.put("sign", SecureUtil.md5(appId + chinese + SALT + pwd)); // 拼接 appid+q+salt+密钥 后MD5加密
...
//        System.out.println("3 = " +  PublicUtil.getWordByteLen("我问问"));
         String aa = converToEN("SMC Automation AB. Ekhaqsvagen 29-31 14171 Segeltorp","20230508001670327","grBoQZa5DSK4PR_aA4J8");
