...
/**
 * @Author C18117
 * 操作 .XLS结尾的Excel文件(当文件为.xls结尾的Excel文件应使用HSSFWorkbook)
 */
@Slf4j
public class XLSExcelUtil {
    ...
    public XLSExcelUtil(String path) {
        try {
    ...
    public XLSExcelUtil(InputStream is) {
        try {
    ...
    public void openSheet(Integer sheetIndex) {
        this.setSheet(workBook.getSheetAt(sheetIndex));
