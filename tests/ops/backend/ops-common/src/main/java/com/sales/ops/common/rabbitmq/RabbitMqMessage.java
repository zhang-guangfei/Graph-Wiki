...
public class RabbitMqMessage implements Serializable {
    ...
    public RabbitMqMessage(String content, String flag, String dataType, String system) throws OpsException{
        super();
        if(StringUtils.isBlank(dataType)) {
            throw Exceptions.OpsException("rabbitMqMessage属性dataType不能为空");
        }
