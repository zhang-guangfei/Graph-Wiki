package com.sales.ops.common.interceptor;

import com.sales.ops.common.until.TextUtil;
import okhttp3.*;
import okio.Buffer;
 ...
 * @version: 1.0$
 * @description：拦截器
 * @date ：Created in 2021/10/29 8:59
 */
public class OkHttpInterceptor implements Interceptor {
    ...
    private boolean canInjectIntoBody(Request request) {
        ...
        if (!TextUtil.equals(request.method(), "POST")) {
            return false;
        }
        ...
        if (!TextUtil.equals(mediaType.subtype(), "x-www-form-urlencoded")) {
            return false;
        }
        return true;
    }
    ...
    public static class Builder {
        ...
        public OkHttpInterceptor build() {
            return interceptor;
        }
