...
public class PurchaseConvertServiceImpl implements PurchaseConvertService {
    ...
    public OrderNoInfo convertPoNoFormPurchase(String no, String item) {
        ...
        OpsPurchaseinvoiceExample e = new OpsPurchaseinvoiceExample();
        e.createCriteria().andPonoEqualTo(no).andLineitemEqualTo(lineitem);
        List<OpsPurchaseinvoice> list = opsPurchaseInvoiceMapper.selectByExample(e);
        ...
        OpsPurchaseinvoice invoice = list.get(0);
