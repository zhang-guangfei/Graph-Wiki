  ...
  <div>
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="常规" name="first">
        <el-form-item v-show="true" label="编号" >
          <el-input v-model="id" readonly/>
        </el-form-item>
        <el-form-item label="流程名称" required>
          <el-input v-model="name"/>
        </el-form-item>
        <el-form-item v-show="true" label="目标命名空间">
          <el-input v-model="process_namespace"/>
        </el-form-item>
        <el-form-item label="候选开始组">
          <el-input v-model="candidateStarterGroups"/>
        </el-form-item>
      ...
      <el-tab-pane label="监听" name="second">
        ...
        <el-form-item v-show="isShow" v-model="listenerValueLabel" >
...
<script>
import elementHelper from '@/api/bpmnjs/helper/elementHelper'
export default {
  // 依赖注入
  // props: ['element'],
  props: {
