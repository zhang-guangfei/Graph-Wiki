<template>
  <div>
    ...
    <el-dialog :visible.sync="dialogTableVisible" :modal="false" title="跳转条件配置" width="1000px" @close="closeDialog">
      <el-container>
        <el-main>
          <el-container>
            <el-aside width="500px">
              <el-table :data="table.conditions" :highlight-current-row="true" border height="200" @row-click="selectRow">
              ...
              <div v-if="formShow === true">
                <el-form label-width="auto" size="mini" label-position="top">
                  ...
                  <el-form-item label="值">
                    <AdapterComponent :type ="form.tmp.componentType" :data="form.tmp.conditionalValData" v-model="form.conditionalVal"/>
                  </el-form-item>
...
import AdjacencyMatrixGraph from '@/api/bpmnjs/util/adjacencyMatrixGraph'
import { OperatorAllOptions, LogicOptions, wfResult, OperatorLessOptions } from '@/api/bpmnjs/static/static'
import { isBlank } from '@/api/bpmnjs/util/commonUtils'
import AdapterComponent from '@/components/Activiti/adapterComponent.vue'
// import { IntAttri } from '@/api/bpmnjs/static/static'

const eventDefinitionHelper = require('@/api/bpmnjs/helper/eventDefinitionHelper')
// isAny = require('bpmn-js/lib/features/modeling/util/ModelingUtil').isAny,
const elementHelper = require('@/api/bpmnjs/helper/elementHelper')
